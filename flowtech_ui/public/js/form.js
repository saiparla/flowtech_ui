const formtabs = () => {
    ...
    buttons.forEach(btn => {
        btn.style.color = '#3271c2';
        btn.style.borderBottom = 'none';
        btn.style.fontWeight = '400';
    });

    if (activeButton) {
        activeButton.style.color = '#525252';
        activeButton.style.fontWeight = '600';
        activeButton.style.borderBottom = '2px solid #3271c2';
    }
    if (commentBox) {
...
const styleFormInputs = () => {
    ...
    document.querySelectorAll(selectors).forEach(el => {
        ...
        el.style.boxShadow = '0 0 5px #ccc';
    ...
    document
        ...
        .forEach(control => {
            ...
            if (toolbar && !toolbar.dataset.styled) {
                ...
                toolbar.style.boxShadow = '0 0 5px #ccc';
